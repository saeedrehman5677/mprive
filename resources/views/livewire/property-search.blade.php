                ...
                <div class="row">
                   @if(count($properties) <=0)
                       <div style="margin-top: 100px"  class="text-center col-md-12">
                           <h5><span style="font-size: 70px;" class="box-icon w-100">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="homeya-box">
                                <div class="archive-top">
                                    ...
                                    <div class="content">
                                        <div class="text-1 text-capitalize"><a href="property-details-v1.html" class="link">
                                ...
                                <div class="archive-bottom d-flex justify-content-between align-items-center">
                                    <p>@if($property?->getDeveloper?->image)
