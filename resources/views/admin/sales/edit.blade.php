        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.sales.update", [$sale->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('property') ? 'is-invalid' : '' }}" type="text" name="property" id="property" value="{{ old('property', $sale->property) }}" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input onkeyup="convertToSLug(this.value)" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $sale->title) }}" required>
                    @if($errors->has('title'))
                        <div class="invalid-feedback">
                            {{ $errors->first('title') }}
                        </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control {{ $errors->has('sub_title') ? 'is-invalid' : '' }}" name="sub_title" id="sub_title">{{ old('sub_title', $sale->sub_title) }}</textarea>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $sale->slug) }}" required>
                    @if($errors->has('slug'))
                        <div class="invalid-feedback">
                            {{ $errors->first('slug') }}
                        </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control {{ $errors->has('emirates') ? 'is-invalid' : '' }}" name="emirates" id="emirates" required>
                        <option value disabled {{ old('emirates', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                        @foreach(App\Models\Sale::EMIRATES_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('emirates', $sale->emirates) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $sale->location) }}" required>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('size') ? 'is-invalid' : '' }}" type="number" name="size" id="size" value="{{ old('size', $sale->size) }}" step="1" required>
                    @if($errors->has('size'))
                        <div class="invalid-feedback">
                            {{ $errors->first('size') }}
                        </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $sale->price) }}" step="0.01" required>
                    @if($errors->has('price'))
                        <div class="invalid-feedback">
                            {{ $errors->first('price') }}
                        </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('discounted_price') ? 'is-invalid' : '' }}" type="number" name="discounted_price" id="discounted_price" value="{{ old('discounted_price', $sale->discounted_price) }}" step="0.01">
                ...
                <div class="form-group col-md-4">
                    <label class="required" for="bathrooms">{{ trans('cruds.sale.fields.bathrooms') }}</label>
                    <input class="form-control {{ $errors->has('bathrooms') ? 'is-invalid' : '' }}" type="number" name="bathrooms" id="bathrooms" value="{{ old('bathrooms', $sale->bathrooms) }}" step="1" required>
                ...
                <div class="form-group col-md-4">
                    <label class="required" for="bed_rooms">{{ trans('cruds.sale.fields.bed_rooms') }}</label>
                    <input class="form-control {{ $errors->has('bed_rooms') ? 'is-invalid' : '' }}" type="number" name="bed_rooms" id="bed_rooms" value="{{ old('bed_rooms', $sale->bed_rooms) }}" step="1" required>
                ...
                <div class="form-group  col-md-4">
                    <label class="required" for="year_built">{{ trans('cruds.sale.fields.year_built') }}</label>
                    <input class="form-control date {{ $errors->has('year_built') ? 'is-invalid' : '' }}" type="text" name="year_built" id="year_built" value="{{ old('year_built', $sale->year_built) }}" required>
                ...
                <div class="form-group  col-md-4">
                    ...
                    <select class="form-control select2 {{ $errors->has('developer') ? 'is-invalid' : '' }}" name="developer" id="developer">
                        ...
                        @foreach($developers as $id => $entry)
                            <option value="{{ $id }}" {{ (old('developer') ? old('developer') : $sale->getDeveloper->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group  col-md-4">
                    ...
                    <select class="form-control {{ $errors->has('property_status') ? 'is-invalid' : '' }}" name="property_status" id="property_status" required>
                        <option value disabled {{ old('property_status', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                        @foreach(App\Models\Sale::PROPERTY_STATUS_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('property_status', $sale->property_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    ...
                    <div class="form-group  col-md-12">
                        ...
                        <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $sale->description) !!}</textarea>
                    ...
                    <div class="form-group  col-md-12">
                        ...
                        <select class="form-control {{ $errors->has('publishing_status') ? 'is-invalid' : '' }}" name="publishing_status" id="publishing_status">
                            <option value disabled {{ old('publishing_status', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                            @foreach(App\Models\Sale::PUBLISHING_STATUS_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('publishing_status', $sale->publishing_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        ...
                        @endif
                        <span class="help-block">{{ trans('cruds.sale.fields.publishing_status_helper') }}</span>
                    </div>
                    <div class="form-group  col-md-6">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('gallery_images') ? 'is-invalid' : '' }}" id="gallery_images-dropzone">
                    </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2 {{ $errors->has('property_types') ? 'is-invalid' : '' }}" name="property_types[]" id="property_types" multiple>
                        @foreach($property_types as $id => $property_type)
                            <option value="{{ $id }}" {{ (in_array($id, old('property_types', [])) || $sale->property_types->contains($id)) ? 'selected' : '' }}>{{ $property_type }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2 {{ $errors->has('amenities') ? 'is-invalid' : '' }}" name="amenities[]" id="amenities" multiple>
                        @foreach($amenities as $id => $amenity)
                            <option value="{{ $id }}" {{ (in_array($id, old('amenities', [])) || $sale->amenities->contains($id)) ? 'selected' : '' }}>{{ $amenity }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('nearby') ? 'is-invalid' : '' }}" name="nearby" id="nearby">{!! old('nearby', $sale->nearby) !!}</textarea>
                ...
                <div class="form-group col-md-4">
                    <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" {{ $sale->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                        <label class="form-check-label" for="featured">{{ trans('cruds.sale.fields.featured') }}</label>
                    </div>
                ...
                <div class="form-group col-md-4">
                    <div class="form-check {{ $errors->has('top_properties') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="top_properties" id="top_properties" value="1" {{ $sale->top_properties || old('top_properties', 0) === 1 ? 'checked' : '' }}>
                        <label class="form-check-label" for="top_properties">{{ trans('cruds.sale.fields.top_properties') }}</label>
                    </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $sale->meta_title) }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('meta_content') ? 'is-invalid' : '' }}" type="text" name="meta_content" id="meta_content" value="{{ old('meta_content', $sale->meta_content) }}">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" id="meta_description">{{ old('meta_description', $sale->meta_description) }}</textarea>
...
@section('scripts')
    ...
    <script>
        ...
        Dropzone.options.galleryImagesDropzone = {
            url: '{{ route('admin.sales.storeMedia') }}',
            maxFilesize: 1, // MB
            acceptedFiles: '.jpeg,.webp,.jpg,.png,.gif',
            addRemoveLinks: true,
            headers: {
                'X-CSRF-TOKEN': "{{ csrf_token() }}"
            },
