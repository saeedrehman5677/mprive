                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label class="required"
                               for="featured_image">{{ trans('cruds.blog.fields.featured_image') }}</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status"
                            ...
                            @foreach(App\Models\Blog::STATUS_SELECT as $key => $label)
                                <option
                                    value="{{ $key }}" {{ old('status', 'draft') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-12">
                        <label for="detail_images">{{ trans('cruds.blog.fields.detail_images') }}</label>
                        <div class="needsclick dropzone {{ $errors->has('detail_images') ? 'is-invalid' : '' }}"
                             id="detail_images-dropzone">
                        </div>
                        @if($errors->has('detail_images'))
                            <div class="invalid-feedback">
                                {{ $errors->first('detail_images') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.blog.fields.detail_images_helper') }}</span>
                    </div>

                    <div class="form-group col-md-6">
                        <label for="meta_title">{{ trans('cruds.blog.fields.meta_title') }}</label>
                        <input  onkeyup="convertToSLug(this.value)" class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('meta_content') ? 'is-invalid' : '' }}" type="text"
